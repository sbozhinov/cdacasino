...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <?php
        if ($page_title == "Coeur d'Alene Casino Resort: Sunrise Room Tour" || $page_title == "Coeur d'Alene Casino Resort: Sunset Room Tour" || $page_title == "Circling Raven Golf Club: Course Tour")
                    ...
                    <div id="header">
                        ...
                        <div id="search">
                            <form  action="../search.php" method="post">
                                <input autocomplete="off" type="text" name="q" class="search_text" value="search site..."/>
