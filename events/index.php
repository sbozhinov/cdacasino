...
$prev_url = "<a class='prev_month_link' href=\"index.php?month=" . ($current_month - 1) . "\">" . $prev_month . " Events </a>";
$next_url = "<a class='next_month_link' href=\"index.php?month=" . ($current_month + 1) . "\">". $next_month ." Events </a>";

$month_str = date("F", $current_date);
echo "<div class='calendar_heading'>".$prev_url."<div class='heading1'><h1> ".$month_str." Events Calendar</h1></div>".$next_url."</div>";
